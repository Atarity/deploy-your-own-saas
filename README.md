...
- [Pterodactyl](https://pterodactyl.io) — open-source game server management panel. Pterodactyl runs all game servers in isolated Docker containers while exposing a beautiful and intuitive UI to end users. [(Github)](https://github.com/pterodactyl/panel)
----
